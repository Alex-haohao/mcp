Create a horizontal 4-frame sprite strip for the mouth of the same StackChan character, emotion: neutral.
Each frame is 96x48; total image is 384x48.
Frame order: closed, small open, medium open, wide open.
Keep the same anchor point, palette, outline, material, and style across all four frames.
