Create a horizontal 4-frame sprite strip for the right eye of the same StackChan character, emotion: neutral.
...
Keep the same scale, anchor point, palette, outline, material, and style across all four frames.
